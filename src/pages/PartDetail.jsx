      ...
      <div style={{
        ...
        <div style={{ overflowY: 'auto', flex: 1, padding: '0 var(--sp-5)', paddingBottom: 'calc(var(--sp-2))' }}>
          ...
          <div style={{ borderTop: '1px solid var(--border-l)', margin: 'var(--sp-3) 0', paddingTop: 'var(--sp-3)' }}>
            <div style={{ fontSize: 'var(--fs-xs)', fontWeight: 700, color: 'var(--text-2)', marginBottom: 'var(--sp-3)' }}>Stock Adjustment</div>
          </div>
          ...
          {/* Divider */}
          <div style={{ borderTop: '1px solid var(--border-l)', margin: 'var(--sp-3) 0', paddingTop: 'var(--sp-3)' }}>
            <div style={{ fontSize: 'var(--fs-xs)', fontWeight: 700, color: 'var(--text-2)', marginBottom: 'var(--sp-3)' }}>Thresholds</div>
          </div>
