    ...
    <div style={{ marginBottom: 'var(--mar-m)' }}>
      ...
      {open && items.map((item, idx) => (
        <div key={item.id} style={{
          display: 'grid',
          gridTemplateColumns: '1fr 3.5rem 5rem 6.5rem',
          gap: 'var(--gap-s)',
    ...
    <div className="page-content fade-in">
      ...
      {sections.length > 0 && (
        <div style={{ background: 'var(--white)', borderRadius: 'var(--r-m)', overflow: 'hidden', marginBottom: 'var(--mar-l)', maxWidth: '100%' }}>
          {/* Column headers */}
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 3.5rem 5rem 6.5rem', gap: 'var(--gap-s)', padding: 'var(--pad-l)', background: 'var(--white)', borderBottom: '1px solid var(--border-l)', borderRadius: 'var(--r-m) var(--r-m) 0 0' }}>
